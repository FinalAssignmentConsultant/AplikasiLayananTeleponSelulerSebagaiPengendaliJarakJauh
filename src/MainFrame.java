...
import core.system.AboutBox;
import core.system.ApplicationInfo;
import core.system.PrivilegeDialog;
import java.awt.Frame;
//import modules.PengendaliJarakJauh;
import modules.konfigurasi.KonfigurasiDialog;
...
public class MainFrame extends javax.swing.JFrame implements AuthenticationListener {
    ...
    private MainFrame() {
        ...
        scrollUtama.setViewportView(PengendaliJarakJauh.getInstance());
    ...
    private void initComponents() {
        ...
        setTitle("Aplikasi Layanan SMS Telepon Seluler Sebagai Pengendali Jarak Jauh Peralatan Listrik Bebasis Komputer");
        ...
        jMenuItem1.setText("Konfigurasi..");
        jMenuItem1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem1ActionPerformed(evt);
            }
        });
        mnuSistem.add(jMenuItem1);
        ...
        mnuPelanggan.setText("Peralatan");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(scrollUtama, javax.swing.GroupLayout.DEFAULT_SIZE, 396, Short.MAX_VALUE)
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(scrollUtama, javax.swing.GroupLayout.DEFAULT_SIZE, 444, Short.MAX_VALUE)
                .addContainerGap())
        );

        java.awt.Dimension screenSize = java.awt.Toolkit.getDefaultToolkit().getScreenSize();
        setBounds((screenSize.width-424)/2, (screenSize.height-521)/2, 424, 521);
...
// TODO add your handling code here:
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        if (PrivilegeDialog.getInstance().isCorrect()) {
            KonfigurasiDialog.getInstance().setVisible(true);
        }
    ...
    private void mnuHomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuHomeActionPerformed
        PengendaliJarakJauh.getInstance().setModul(0);
    ...
    private void mnuPelangganActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuPelangganActionPerformed
        PengendaliJarakJauh.getInstance().setModul(1);
    ...
    private void mnuInboxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuInboxActionPerformed
        PengendaliJarakJauh.getInstance().setModul(2);
    ...
    private void mnuOutboxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuOutboxActionPerformed
        PengendaliJarakJauh.getInstance().setModul(3);
    ...
    private void mnuLogActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuLogActionPerformed
        PengendaliJarakJauh.getInstance().setModul(4);

 ...
 * EditPegawai.java
 *
 * Created on 03 April 2008, 14:55
 */
 ...
 * @author  SWDEV
 */
public class DaftarInbox extends javax.swing.JPanel {

    private static DaftarInbox instance = null;
    private TableController tblObatController = null;

    public static DaftarInbox getInstance() {
        if (instance == null) {
            instance = new DaftarInbox();
        }
        return instance;
    }
    ...
    private DaftarInbox() {
        initComponents();
        tblObatController = new TableController(this, "sms_inbox", ApplicationLogic.getInstance().getQueryInbox(), tblObat, beanInbox);
    ...
    private void initComponents() {
        ...
        beanInbox = new modules.inbox.BeanInbox();
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(beanInbox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(161, 161, 161)
    ...
    private modules.inbox.BeanInbox beanInbox;
